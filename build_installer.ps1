...
if ($cacertsFile -ne ""){
    ...
    $compress = @{
        LiteralPath = $java_full_file_name, $machine_full_file_name, $network_full_file_name, "./cacerts.jks", "ma_init.sh", "MachineAgentTemplate.service", "appdynamics-machine-agent", "appdy-sysconfig"
    ...
    $compress = @{
        LiteralPath = $java_full_file_name, $machine_full_file_name, $network_full_file_name, "ma_init.sh", "MachineAgentTemplate.service", "appdynamics-machine-agent", "appdy-sysconfig"
        CompressionLevel = "Fastest"
        DestinationPath = $destination_path
    }
}
